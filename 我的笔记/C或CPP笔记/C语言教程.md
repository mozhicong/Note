...
在我们学习 C 语言的基本构建块之前，让我们先来看看一个最小的 C语言教程，在接下来的章节中可以以此作为参考。
...
| int    | 对机器而言，整数的最自然的大小。                             |
| float  | 单精度浮点值。单精度是这样的格式，1位符号，8位指数，23位小数。![img](C语言教程.assets/v2-749cc641eb4d5dafd085e8c23f8826aa_hd.png) |
| double | 双精度浮点值。双精度是1位符号，11位指数，52位小数。![img](C语言教程.assets/v2-48240f0e1e0dd33ec89100cbe2d30707_hd.png) |
| void   | 表示类型的缺失。                                             |
...
1. **右值（rvalue）：**术语右值（rvalue）指的是存储在内存中某些地址的数值。右值是不能对其进行赋值的表达式，也就是说，右值可以出现在赋值号的右边，但不能出现在赋值号的左边。
...
![C 中的判断语句](C语言教程.assets/C-decision-20200923-1.svg)
...
![img](C语言教程.assets/Conditional-Statement-in-C-Programming-Lanuage-Ternary-Operator.png)
...
![C 中的数组](C语言教程.assets/arrays.jpg)
...
![数组表示](C语言教程.assets/array_presentation.jpg)
...
![img](C语言教程.assets/c-pointer.png)
...
![C/C++ 中的字符串表示](C语言教程.assets/string_representation.jpg)
...
![Usual Arithmetic Conversion](C语言教程.assets/usual_arithmetic_conversion.png)
...
![img](C语言教程.assets/recursion_0.png)
...
![img](C语言教程.assets/Bubble_sort_animation.gif)
...
![img](C语言教程.assets/Selection_sort_animation.gif)

![img](C语言教程.assets/Selection-Sort-Animation.gif)
...
![img](C语言教程.assets/Insertion_sort_animation.gif)
...
![img](C语言教程.assets/Sorting_shellsort_anim.gif)
...
![img](C语言教程.assets/Merge_sort_animation2.gif)

![img](C语言教程.assets/Merge-sort-example-300px.gif)
...
![img](C语言教程.assets/Sorting_quicksort_anim.gif)
